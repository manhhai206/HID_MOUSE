...
C_SRCS += \
../libs/tinyusb/src/typec/usbc.c 

OBJS += \
./libs/tinyusb/src/typec/usbc.o 

C_DEPS += \
./libs/tinyusb/src/typec/usbc.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/src/typec/%.o libs/tinyusb/src/typec/%.su libs/tinyusb/src/typec/%.cyclo: ../libs/tinyusb/src/typec/%.c libs/tinyusb/src/typec/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-src-2f-typec

clean-libs-2f-tinyusb-2f-src-2f-typec:
	-$(RM) ./libs/tinyusb/src/typec/usbc.cyclo ./libs/tinyusb/src/typec/usbc.d ./libs/tinyusb/src/typec/usbc.o ./libs/tinyusb/src/typec/usbc.su

.PHONY: clean-libs-2f-tinyusb-2f-src-2f-typec
