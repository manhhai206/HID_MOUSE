...
C_SRCS += \
../libs/tinyusb/hw/bsp/max78002/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/max78002/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/max78002/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/max78002/%.o libs/tinyusb/hw/bsp/max78002/%.su libs/tinyusb/hw/bsp/max78002/%.cyclo: ../libs/tinyusb/hw/bsp/max78002/%.c libs/tinyusb/hw/bsp/max78002/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-max78002

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-max78002:
	-$(RM) ./libs/tinyusb/hw/bsp/max78002/family.cyclo ./libs/tinyusb/hw/bsp/max78002/family.d ./libs/tinyusb/hw/bsp/max78002/family.o ./libs/tinyusb/hw/bsp/max78002/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-max78002
