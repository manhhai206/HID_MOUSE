...
C_SRCS += \
../libs/tinyusb/hw/bsp/xmc4000/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/xmc4000/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/xmc4000/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/xmc4000/%.o libs/tinyusb/hw/bsp/xmc4000/%.su libs/tinyusb/hw/bsp/xmc4000/%.cyclo: ../libs/tinyusb/hw/bsp/xmc4000/%.c libs/tinyusb/hw/bsp/xmc4000/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-xmc4000

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-xmc4000:
	-$(RM) ./libs/tinyusb/hw/bsp/xmc4000/family.cyclo ./libs/tinyusb/hw/bsp/xmc4000/family.d ./libs/tinyusb/hw/bsp/xmc4000/family.o ./libs/tinyusb/hw/bsp/xmc4000/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-xmc4000
