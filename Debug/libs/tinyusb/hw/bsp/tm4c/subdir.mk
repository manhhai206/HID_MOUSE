...
C_SRCS += \
../libs/tinyusb/hw/bsp/tm4c/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/tm4c/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/tm4c/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/tm4c/%.o libs/tinyusb/hw/bsp/tm4c/%.su libs/tinyusb/hw/bsp/tm4c/%.cyclo: ../libs/tinyusb/hw/bsp/tm4c/%.c libs/tinyusb/hw/bsp/tm4c/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-tm4c

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-tm4c:
	-$(RM) ./libs/tinyusb/hw/bsp/tm4c/family.cyclo ./libs/tinyusb/hw/bsp/tm4c/family.d ./libs/tinyusb/hw/bsp/tm4c/family.o ./libs/tinyusb/hw/bsp/tm4c/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-tm4c
