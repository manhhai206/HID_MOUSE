...
C_SRCS += \
../libs/tinyusb/hw/bsp/brtmm90x/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/brtmm90x/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/brtmm90x/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/brtmm90x/%.o libs/tinyusb/hw/bsp/brtmm90x/%.su libs/tinyusb/hw/bsp/brtmm90x/%.cyclo: ../libs/tinyusb/hw/bsp/brtmm90x/%.c libs/tinyusb/hw/bsp/brtmm90x/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-brtmm90x

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-brtmm90x:
	-$(RM) ./libs/tinyusb/hw/bsp/brtmm90x/family.cyclo ./libs/tinyusb/hw/bsp/brtmm90x/family.d ./libs/tinyusb/hw/bsp/brtmm90x/family.o ./libs/tinyusb/hw/bsp/brtmm90x/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-brtmm90x
