...
C_SRCS += \
../libs/tinyusb/hw/bsp/spresense/board_spresense.c 

OBJS += \
./libs/tinyusb/hw/bsp/spresense/board_spresense.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/spresense/board_spresense.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/spresense/%.o libs/tinyusb/hw/bsp/spresense/%.su libs/tinyusb/hw/bsp/spresense/%.cyclo: ../libs/tinyusb/hw/bsp/spresense/%.c libs/tinyusb/hw/bsp/spresense/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-spresense

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-spresense:
	-$(RM) ./libs/tinyusb/hw/bsp/spresense/board_spresense.cyclo ./libs/tinyusb/hw/bsp/spresense/board_spresense.d ./libs/tinyusb/hw/bsp/spresense/board_spresense.o ./libs/tinyusb/hw/bsp/spresense/board_spresense.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-spresense
