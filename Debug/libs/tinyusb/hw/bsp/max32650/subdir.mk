...
C_SRCS += \
../libs/tinyusb/hw/bsp/max32650/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/max32650/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/max32650/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/max32650/%.o libs/tinyusb/hw/bsp/max32650/%.su libs/tinyusb/hw/bsp/max32650/%.cyclo: ../libs/tinyusb/hw/bsp/max32650/%.c libs/tinyusb/hw/bsp/max32650/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-max32650

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-max32650:
	-$(RM) ./libs/tinyusb/hw/bsp/max32650/family.cyclo ./libs/tinyusb/hw/bsp/max32650/family.d ./libs/tinyusb/hw/bsp/max32650/family.o ./libs/tinyusb/hw/bsp/max32650/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-max32650
