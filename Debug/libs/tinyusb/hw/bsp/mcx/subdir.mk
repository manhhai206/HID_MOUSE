...
C_SRCS += \
../libs/tinyusb/hw/bsp/mcx/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/mcx/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/mcx/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/mcx/%.o libs/tinyusb/hw/bsp/mcx/%.su libs/tinyusb/hw/bsp/mcx/%.cyclo: ../libs/tinyusb/hw/bsp/mcx/%.c libs/tinyusb/hw/bsp/mcx/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-mcx

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-mcx:
	-$(RM) ./libs/tinyusb/hw/bsp/mcx/family.cyclo ./libs/tinyusb/hw/bsp/mcx/family.d ./libs/tinyusb/hw/bsp/mcx/family.o ./libs/tinyusb/hw/bsp/mcx/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-mcx
