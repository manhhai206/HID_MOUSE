...
C_SRCS += \
../libs/tinyusb/hw/bsp/stm32c0/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/stm32c0/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/stm32c0/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/stm32c0/%.o libs/tinyusb/hw/bsp/stm32c0/%.su libs/tinyusb/hw/bsp/stm32c0/%.cyclo: ../libs/tinyusb/hw/bsp/stm32c0/%.c libs/tinyusb/hw/bsp/stm32c0/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-stm32c0

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-stm32c0:
	-$(RM) ./libs/tinyusb/hw/bsp/stm32c0/family.cyclo ./libs/tinyusb/hw/bsp/stm32c0/family.d ./libs/tinyusb/hw/bsp/stm32c0/family.o ./libs/tinyusb/hw/bsp/stm32c0/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-stm32c0
