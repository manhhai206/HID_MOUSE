...
C_SRCS += \
../libs/tinyusb/hw/bsp/ra/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/ra/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/ra/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/ra/%.o libs/tinyusb/hw/bsp/ra/%.su libs/tinyusb/hw/bsp/ra/%.cyclo: ../libs/tinyusb/hw/bsp/ra/%.c libs/tinyusb/hw/bsp/ra/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-ra

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-ra:
	-$(RM) ./libs/tinyusb/hw/bsp/ra/family.cyclo ./libs/tinyusb/hw/bsp/ra/family.d ./libs/tinyusb/hw/bsp/ra/family.o ./libs/tinyusb/hw/bsp/ra/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-ra
