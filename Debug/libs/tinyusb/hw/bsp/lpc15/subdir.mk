...
C_SRCS += \
../libs/tinyusb/hw/bsp/lpc15/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/lpc15/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/lpc15/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/lpc15/%.o libs/tinyusb/hw/bsp/lpc15/%.su libs/tinyusb/hw/bsp/lpc15/%.cyclo: ../libs/tinyusb/hw/bsp/lpc15/%.c libs/tinyusb/hw/bsp/lpc15/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-lpc15

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-lpc15:
	-$(RM) ./libs/tinyusb/hw/bsp/lpc15/family.cyclo ./libs/tinyusb/hw/bsp/lpc15/family.d ./libs/tinyusb/hw/bsp/lpc15/family.o ./libs/tinyusb/hw/bsp/lpc15/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-lpc15
