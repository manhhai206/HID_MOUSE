...
C_SRCS += \
../libs/tinyusb/hw/bsp/rp2040/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/rp2040/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/rp2040/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/rp2040/%.o libs/tinyusb/hw/bsp/rp2040/%.su libs/tinyusb/hw/bsp/rp2040/%.cyclo: ../libs/tinyusb/hw/bsp/rp2040/%.c libs/tinyusb/hw/bsp/rp2040/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-rp2040

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-rp2040:
	-$(RM) ./libs/tinyusb/hw/bsp/rp2040/family.cyclo ./libs/tinyusb/hw/bsp/rp2040/family.d ./libs/tinyusb/hw/bsp/rp2040/family.o ./libs/tinyusb/hw/bsp/rp2040/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-rp2040
