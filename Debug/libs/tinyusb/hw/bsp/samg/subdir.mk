...
C_SRCS += \
../libs/tinyusb/hw/bsp/samg/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/samg/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/samg/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/samg/%.o libs/tinyusb/hw/bsp/samg/%.su libs/tinyusb/hw/bsp/samg/%.cyclo: ../libs/tinyusb/hw/bsp/samg/%.c libs/tinyusb/hw/bsp/samg/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-samg

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-samg:
	-$(RM) ./libs/tinyusb/hw/bsp/samg/family.cyclo ./libs/tinyusb/hw/bsp/samg/family.d ./libs/tinyusb/hw/bsp/samg/family.o ./libs/tinyusb/hw/bsp/samg/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-samg
