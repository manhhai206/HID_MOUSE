...
C_SRCS += \
../libs/tinyusb/hw/bsp/broadcom_32bit/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/broadcom_32bit/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/broadcom_32bit/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/broadcom_32bit/%.o libs/tinyusb/hw/bsp/broadcom_32bit/%.su libs/tinyusb/hw/bsp/broadcom_32bit/%.cyclo: ../libs/tinyusb/hw/bsp/broadcom_32bit/%.c libs/tinyusb/hw/bsp/broadcom_32bit/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-broadcom_32bit

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-broadcom_32bit:
	-$(RM) ./libs/tinyusb/hw/bsp/broadcom_32bit/family.cyclo ./libs/tinyusb/hw/bsp/broadcom_32bit/family.d ./libs/tinyusb/hw/bsp/broadcom_32bit/family.o ./libs/tinyusb/hw/bsp/broadcom_32bit/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-broadcom_32bit
