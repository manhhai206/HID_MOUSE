...
C_SRCS += \
../libs/tinyusb/hw/bsp/lpc40/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/lpc40/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/lpc40/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/lpc40/%.o libs/tinyusb/hw/bsp/lpc40/%.su libs/tinyusb/hw/bsp/lpc40/%.cyclo: ../libs/tinyusb/hw/bsp/lpc40/%.c libs/tinyusb/hw/bsp/lpc40/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-lpc40

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-lpc40:
	-$(RM) ./libs/tinyusb/hw/bsp/lpc40/family.cyclo ./libs/tinyusb/hw/bsp/lpc40/family.d ./libs/tinyusb/hw/bsp/lpc40/family.o ./libs/tinyusb/hw/bsp/lpc40/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-lpc40
