...
C_SRCS += \
../libs/tinyusb/hw/bsp/max32666/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/max32666/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/max32666/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/max32666/%.o libs/tinyusb/hw/bsp/max32666/%.su libs/tinyusb/hw/bsp/max32666/%.cyclo: ../libs/tinyusb/hw/bsp/max32666/%.c libs/tinyusb/hw/bsp/max32666/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-max32666

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-max32666:
	-$(RM) ./libs/tinyusb/hw/bsp/max32666/family.cyclo ./libs/tinyusb/hw/bsp/max32666/family.d ./libs/tinyusb/hw/bsp/max32666/family.o ./libs/tinyusb/hw/bsp/max32666/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-max32666
