...
C_SRCS += \
../libs/tinyusb/hw/bsp/msp430/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/msp430/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/msp430/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/msp430/%.o libs/tinyusb/hw/bsp/msp430/%.su libs/tinyusb/hw/bsp/msp430/%.cyclo: ../libs/tinyusb/hw/bsp/msp430/%.c libs/tinyusb/hw/bsp/msp430/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-msp430

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-msp430:
	-$(RM) ./libs/tinyusb/hw/bsp/msp430/family.cyclo ./libs/tinyusb/hw/bsp/msp430/family.d ./libs/tinyusb/hw/bsp/msp430/family.o ./libs/tinyusb/hw/bsp/msp430/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-msp430
