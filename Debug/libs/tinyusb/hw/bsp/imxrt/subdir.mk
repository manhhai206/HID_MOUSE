...
C_SRCS += \
../libs/tinyusb/hw/bsp/imxrt/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/imxrt/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/imxrt/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/imxrt/%.o libs/tinyusb/hw/bsp/imxrt/%.su libs/tinyusb/hw/bsp/imxrt/%.cyclo: ../libs/tinyusb/hw/bsp/imxrt/%.c libs/tinyusb/hw/bsp/imxrt/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-imxrt

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-imxrt:
	-$(RM) ./libs/tinyusb/hw/bsp/imxrt/family.cyclo ./libs/tinyusb/hw/bsp/imxrt/family.d ./libs/tinyusb/hw/bsp/imxrt/family.o ./libs/tinyusb/hw/bsp/imxrt/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-imxrt
