...
C_SRCS += \
../libs/tinyusb/hw/bsp/stm32f1/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/stm32f1/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/stm32f1/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/stm32f1/%.o libs/tinyusb/hw/bsp/stm32f1/%.su libs/tinyusb/hw/bsp/stm32f1/%.cyclo: ../libs/tinyusb/hw/bsp/stm32f1/%.c libs/tinyusb/hw/bsp/stm32f1/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-stm32f1

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-stm32f1:
	-$(RM) ./libs/tinyusb/hw/bsp/stm32f1/family.cyclo ./libs/tinyusb/hw/bsp/stm32f1/family.d ./libs/tinyusb/hw/bsp/stm32f1/family.o ./libs/tinyusb/hw/bsp/stm32f1/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-stm32f1
