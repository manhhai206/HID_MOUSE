...
C_SRCS += \
../libs/tinyusb/hw/bsp/broadcom_64bit/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/broadcom_64bit/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/broadcom_64bit/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/broadcom_64bit/%.o libs/tinyusb/hw/bsp/broadcom_64bit/%.su libs/tinyusb/hw/bsp/broadcom_64bit/%.cyclo: ../libs/tinyusb/hw/bsp/broadcom_64bit/%.c libs/tinyusb/hw/bsp/broadcom_64bit/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-broadcom_64bit

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-broadcom_64bit:
	-$(RM) ./libs/tinyusb/hw/bsp/broadcom_64bit/family.cyclo ./libs/tinyusb/hw/bsp/broadcom_64bit/family.d ./libs/tinyusb/hw/bsp/broadcom_64bit/family.o ./libs/tinyusb/hw/bsp/broadcom_64bit/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-broadcom_64bit
