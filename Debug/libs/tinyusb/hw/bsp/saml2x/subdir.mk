...
C_SRCS += \
../libs/tinyusb/hw/bsp/saml2x/family.c 

OBJS += \
./libs/tinyusb/hw/bsp/saml2x/family.o 

C_DEPS += \
./libs/tinyusb/hw/bsp/saml2x/family.d 


# Each subdirectory must supply rules for building sources it contributes
libs/tinyusb/hw/bsp/saml2x/%.o libs/tinyusb/hw/bsp/saml2x/%.su libs/tinyusb/hw/bsp/saml2x/%.cyclo: ../libs/tinyusb/hw/bsp/saml2x/%.c libs/tinyusb/hw/bsp/saml2x/subdir.mk
...
clean: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-saml2x

clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-saml2x:
	-$(RM) ./libs/tinyusb/hw/bsp/saml2x/family.cyclo ./libs/tinyusb/hw/bsp/saml2x/family.d ./libs/tinyusb/hw/bsp/saml2x/family.o ./libs/tinyusb/hw/bsp/saml2x/family.su

.PHONY: clean-libs-2f-tinyusb-2f-hw-2f-bsp-2f-saml2x
